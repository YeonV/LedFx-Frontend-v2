...
const DeviceCard = ({ virtual, index }) => {
  ...
  const [isActive, setIsActive] = useState(Object.keys(virtuals[virtual]?.effect).length > 0 || devices[Object.keys(devices).find(d => d === virtual)]?.active_virtuals.length > 0)
