...
import { useTheme, Button, Fab, MenuItem, ListItemIcon, Badge } from '@mui/material'
...
const steps = [
  {
    ...
    content: (
      <div>
        <h2>LedFx Tour</h2>
        Welcome to LedFx! Feel free to follow this tour and we&apos;ll show you around 😊
      </div>
    ),
    style: {
    ...
    content: (
      <div>
        ...
        <ul style={{ paddingLeft: '1rem' }}>
          ...
          <li>
            👀 &apos;Enable Graphs&apos; to see a preview of the device LEDs. Leave it off if your
            browser struggles with too many pixels!
          </li>
        </ul>
      </div>
    ),
