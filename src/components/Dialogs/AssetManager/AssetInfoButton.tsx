...
import { Info, Close, ColorLens } from '@mui/icons-material'
...
const AssetInfoButton = ({ asset }: AssetInfoButtonProps) => {
  ...
  return (
    <>
      <IconButton size="small" color="info" onClick={handleClick} title="Show asset information">
        <Info />
      </IconButton>
