...
const LaunchpadColors = ({
  ...
  return (
    <div>
      {component === 'Button' ? (
        <Button onClick={handleClickOpen}>Global Colors</Button>
      ) : (
          ...
          <Stack direction={'column'} spacing={1} mt={1}>
            ...
            >
              ...
              <Stack direction={'row'}>
                ...
                />
                <LpColorPicker
                  type={sceneInactiveType || lp.globalColors.sceneInactiveType}
                  defaultColor={
                    isRgb && midiSceneInactiveColor.startsWith('rgb')
                      ? midiSceneInactiveColor
                      : getColorFromValue(midiSceneInactiveColor)
                  }
            ...
            >
              ...
              <Stack direction={'row'}>
                ...
                />
                <LpColorPicker
                  type={sceneActiveType || lp.globalColors.sceneActiveType}
                  defaultColor={
                    isRgb && midiSceneActiveColor.startsWith('rgb')
                      ? midiSceneActiveColor
                      : getColorFromValue(midiSceneActiveColor)
                  }
                  onColorSelect={(color: string) => {
            ...
            >
              ...
              <Stack direction={'row'}>
                ...
                />
                <LpColorPicker
                  type={commandType || lp.globalColors.commandType}
                  defaultColor={
