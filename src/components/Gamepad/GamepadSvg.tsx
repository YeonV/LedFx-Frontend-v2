    ...
    <svg width="350" viewBox="0 0 441 383" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="XBox">
        ...
        <circle
          ...
          r="28"
          fill={
            pad.axes[0] > 0.05 || pad.axes[0] < -0.05 || pad.axes[1] > 0.05 || pad.axes[1] < -0.05
              ? theme.palette.primary.main
              : fill
          }
          stroke={pad.buttons[10].pressed ? `${theme.palette.primary.main}90` : stroke2}
          strokeWidth={strokeWidth}
        />
        <circle
          id="RStickOutline"
        ...
        <circle
          ...
          r="28"
          fill={
            pad.axes[2] > 0.05 || pad.axes[2] < -0.05 || pad.axes[3] > 0.05 || pad.axes[4] < -0.05
              ? theme.palette.primary.main
              : fill
          }
          stroke={pad.buttons[11].pressed ? theme.palette.primary.main : stroke2}
          strokeWidth={strokeWidth}
        />
        <circle
          id="DOutline"
        ...
        <g id="DUp">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[12].pressed ? theme.palette.primary.main : stroke2}
        ...
        <g id="DRight">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[15].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="DDown">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[13].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="DLeft">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[14].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="BTop">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[3].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="BRight">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[1].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="BBottom">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[0].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="BLeft">
          ...
          <path
            ...
            fill={fill}
            stroke={pad.buttons[2].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth2}
        ...
        <g id="LMeta">
          <circle
            ...
            r="10"
            fill={fill}
            stroke={pad.buttons[8].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth}
          />
        </g>
        <g id="MMeta">
          <circle
            ...
            r="12"
            fill={fill}
            stroke={pad.buttons[16].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth}
          />
        </g>
        <g id="RMeta">
          <circle
            ...
            r="10"
            fill={fill}
            stroke={pad.buttons[9].pressed ? theme.palette.primary.main : stroke2}
            strokeWidth={strokeWidth}
          />
        </g>
        <rect
